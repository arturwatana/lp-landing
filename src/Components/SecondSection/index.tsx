...
export default function SecondSection(){
    ...
    return (
        <>
            <Flex flexDir={"column"} w="100%" h="100%" py="90px"  alignItems={"center"} gap="0px">
                ...
                <Flex w="65%" flexWrap={"wrap"}  gap="40px" alignItems={"center"} justifyContent={"space-around"}>
                    {cardsList.map((phrase, index) => <Card tittle={phrase} customValue={index}/>)}
                </Flex>
            </Flex>
            <Flex justifyContent={"center"}  w="100%" alignItems={"center"} h="100%" background={"#e5e5e5"} py="130px">
                <Flex  h="100%"  justifyContent={"center"}  alignItems={"center"} gap="80px" >
                    <Flex gap="40px" h="100%" justifyContent={"center"}  alignItems={"center"}>
                        ...
                        <motion.div whileInView={"render"} viewport={{once: true}} variants={variants} initial={{y: 200, opacity: 0}} style={{background:"#fff", borderRadius:"5px", color:"#ff6418", display: "flex", justifyContent:"center", alignItems:"center", flexDirection:"column", padding: "25px 35px"}}>
